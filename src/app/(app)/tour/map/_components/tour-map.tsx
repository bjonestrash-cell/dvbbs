...
export function TourMap({
  ...
  useEffect(() => {
    ...
    // pins is computed from shows, so the only dep that matters is shows identity.
    ...
    <div className="relative w-full h-[460px] md:h-[560px] bg-surface border border-line">
      ...
      {pins.length === 0 ? (
        <div className="absolute inset-0 grid place-items-center">
          <div className="bg-surface/95 backdrop-blur border border-line px-4 py-3 max-w-[260px] text-center">
